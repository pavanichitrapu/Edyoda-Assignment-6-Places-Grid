...
function createCard(cardUrl, cardAltText, cardHeaders, cardDescription){
    ...
    cardHeading.classList.add('cardHeader');
    cardHeading.innerText = cardHeaders;
    cardContent.appendChild(cardHeading);

    var cardDesc = document.createElement('p');
    cardDesc.classList.add('cardText');
    cardDesc.innerText = cardDescription;
...
var mainGrid=document.getElementById('grid');
  ...
  {
      var videoCard = createCard(cards[i].imgUrl, cards[i].imgAlt, cards[i].header, cards[i].description);
